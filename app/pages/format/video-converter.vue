<template>
  <div class="video-converter-page">
    <h1 class="page-title">视频格式转换工具</h1>
      ...
      <div class="upload-section">
        <div class="upload-area" @click="triggerFileInput" @dragover.prevent @drop.prevent="handleDrop">
          ...
          <div class="upload-text">
            <p>拖拽视频文件到此处或点击上传</p>
            <p class="upload-hint">支持 MP4, AVI, MOV, MKV, WMV 格式</p>
          </div>
          <input 
            type="file" 
            ref="fileInput" 
      ...
      <div class="options-section">
        ...
        <div class="option-group">
          ...
          <select class="option-select" v-model="quality">
            ...
            <option value="medium">标准质量 (720p)</option>
        ...
        <div class="option-group">
          <label class="option-label">比特率</label>
          <select class="option-select" v-model="bitrate">
            <option value="auto">自动</option>
            <option value="high">高比特率</option>
            <option value="medium">中等比特率</option>
            <option value="low">低比特率</option>
          </select>
        </div>
    ...
    <div class="info-section">
      <h2>功能说明</h2>
      <p>这是一个功能强大的视频格式转换工具，支持多种视频格式之间的相互转换。</p>
      <ul>
        <li>支持 MP4, AVI, MOV, MKV, WMV 等常见视频格式</li>
        <li>批量转换，一次处理多个文件</li>
        <li>支持拖拽上传，操作简便</li>
        <li>可自定义输出质量、帧率和比特率</li>
        <li>支持移除音频和保持宽高比</li>
        <li>转换速度快，保持原视频质量</li>
      </ul>
    </div>
...
const outputFormats = [
  { value: 'mp4', name: 'MP4', icon: '🎬' },
  { value: 'avi', name: 'AVI', icon: '📹' },
  { value: 'mov', name: 'MOV', icon: '🎥' },
  { value: 'mkv', name: 'MKV', icon: '📼' },
  { value: 'wmv', name: 'WMV', icon: '🎞' }
]
