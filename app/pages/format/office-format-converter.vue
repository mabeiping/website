<template>
  <div class="office-converter-page">
    <h1 class="page-title">Office文档格式转换工具</h1>
    ...
    <div class="converter-container">
      <div class="upload-section">
        <div class="upload-area" @click="triggerFileInput" @dragover.prevent @drop.prevent="handleDrop">
          ...
          <div class="upload-text">
            <p>拖拽文件到此处或点击上传</p>
            <p class="upload-hint">支持 Word, Excel, PowerPoint, PDF 格式</p>
          </div>
          <input 
            type="file" 
            ref="fileInput" 
      ...
      <div class="options-section">
        ...
        <div class="option-group">
          <label class="option-label">
            <input type="checkbox" v-model="mergeSheets" />
            合并Excel工作表
          </label>
        </div>
      </div>
    ...
    <div class="info-section">
      <h2>功能说明</h2>
      <p>这是一个功能强大的Office文档格式转换工具，支持多种格式之间的相互转换。</p>
      <ul>
        <li>支持 Word (DOC, DOCX), Excel (XLS, XLSX), PowerPoint (PPT, PPTX), PDF 格式</li>
        <li>批量转换，一次处理多个文件</li>
        <li>支持拖拽上传，操作简便</li>
...
const outputFormats = [
  ...
  { value: 'xlsx', name: 'XLSX', icon: '📊' },
  { value: 'pptx', name: 'PPTX', icon: '📽' },
